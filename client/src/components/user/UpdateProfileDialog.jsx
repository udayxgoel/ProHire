        ...
        <form onSubmit={submitHandler}>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="fullname" className="text-right font-bold">
                Name:
              </Label>
              <Input
                type="text"
          ...
          <DialogFooter>
            {loading ? (
              <Button className="w-full my-2 bg-[#1E88E5] hover:bg-[#1669b2]">
              ...
              <Button
                type="submit"
                className="w-full my-2 bg-[#1E88E5] hover:bg-[#1669b2]"
              >
                Update Profile
              </Button>
            )}
